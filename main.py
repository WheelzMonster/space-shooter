...
pygame.display.set_caption("Star Wars Rogue Squadron 3")
...
def main():
    ...
    def redraw_window():
        ...
        if lost:
            lost_label = lost_font.render("t'es mort!", 1, (255,255,255))
...
def main_menu():
    ...
    while run:
        WIN.blit(BG, (0,0))
        title_label = title_font.render("click gauche pour commencer...", 1, (255,255,255))
